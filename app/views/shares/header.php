...
<head>
    ...
    <title>SopCuaPhat - Quản Lý Bán Hàng</title>
    <meta name="description" content="SopCuaPhat - Cửa hàng công nghệ. Giao diện trắng chủ đạo, điểm nhấn đỏ.">
    <!-- Google Font Inter -->
    ...
    <!-- Theme: white with red accents -->
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>/public/css/theme-red.css">
    <!-- SweetAlert2 -->
    ...
    <script>
        ...
        (function() {
            // Default to light theme for the new white/red design
    ...
    <style>
        ...
        /* User badge in nav (theme-aware for good contrast) */
        .user-badge {
            display: inline-flex;
            align-items: center;
            gap: 0.5rem;
            ...
            font-size: 12px;
            border: 1px solid rgba(0,0,0,0.06);
            background: rgba(255,255,255,0.9); /* default for light */
            color: var(--text-dark);
        ...
        .user-badge .user-avatar {
            ...
            height: 22px;
            border-radius: 50%;
            background: var(--accent-red); /* brand red for strong contrast */
            display: flex;
            align-items: center;
            justify-content: center;
            font-size: 10px;
        ...
        /* Slightly different avatar color in pure dark mode if needed */
        [data-theme="dark"] .user-badge .user-avatar {
    ...
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top">
        <div class="container">
            <a class="navbar-brand" href="<?php echo BASE_URL; ?>/">
                <i class="fa-solid fa-laptop-code me-2 text-danger"></i>SopCuaPhat
            </a>
